...
codesign --entitlements resources/mac/Product.entitlements  --force -v --options=runtime  --deep --timestamp --file-list - -s $SIGNING_IDENTITY GToolkitOSX64-*/GToolkit.app
codesign --entitlements resources/mac/Product.entitlements  --force -v --options=runtime  --deep --timestamp --file-list - -s $SIGNING_IDENTITY GToolkitOSX64-*/*.dylib 
