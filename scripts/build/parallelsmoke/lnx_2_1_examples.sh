...
timeout 25m xvfb-run -a ./GlamorousToolkitLinux64*/glamoroustoolkit GlamorousToolkitLinux64*/GlamorousToolkit.image dedicatedReleaseBranchExamples --junit-xml-output --verbose
