...
./gtoolkit Pharo.image examples --interactive --no-quit --junit-xml-output 'GToolkit-Releaser-.*' 2>&1
./gtoolkit Pharo.image Pharo.image eval --save "ThreadedFFIMigration enableThreadedFFI." 
