...
Expand-Archive build-artifacts\GlamorousToolkitVM-8.2.0-*-win64-bin.zip  -DestinationPath GToolkit
...
Move-Item .\GToolkit\Pharo8.0-SNAPSHOT-64bit-*.image .\GToolkit\Pharo.image
Move-Item .\GToolkit\Pharo8.0-SNAPSHOT-64bit-*.changes .\GToolkit\Pharo.changes
