...
- [GToolkit4Smacc](https://github.com/feenkcom/gt4smacc): the user interface for creating, debugging and testing SmaCC-based parsers.
- [GToolkit4PetitParser2](https://github.com/feenkcom/gt4petitparser2): the user interface for creating, debugging and testing PetitParser2-based parsers.
- [GToolkit4Famix3](https://github.com/feenkcom/gt4famix3): the user interface and dedicated importers that work with the Famix meta-model for source code analysis.
